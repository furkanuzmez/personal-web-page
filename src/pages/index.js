    ...
    return (
      <Layout location={this.props.location} title={siteTitle}>
        ...
        <div class="okvir">
          ...
          <SkillCircle percentage="70" subject="Python"/>
          <SkillCircle percentage="60" subject="Java"/>
          <SkillCircle percentage="75" subject="C#"/>
          ...
          <SkillCircle percentage="80" subject="Linux"/>
          <SkillCircle percentage="80" subject="SQL"/>
          <SkillCircle percentage="80" subject="Open-CV"/>
